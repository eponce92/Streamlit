...
def main():
    ...
    st.markdown(
        f'<h1 class="streamlit-header">Audio Transcriber GPT <https://github.com/eponce92/Streamlit/blob/main/audio-transctipt-ilustration.png" style="height:200px;margin-left:10px;"></h1>',
